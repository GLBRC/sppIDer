...
spcAvgFile <- paste(workingDir, strainName, "speciesAvgDepth-g.txt", sep="_")
chrAvgFile <- paste(workingDir, strainName, "chrAvgDepth-g.txt", sep="_")
outputFileName <- paste(workingDir, strainName, "winAvgDepth-g.txt", sep="_")
